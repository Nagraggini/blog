...
HTML5 → strukturált, szemantikus elemek, formok, táblázatok, meta tag-ek.
CSS3 → layoutok (flexbox, grid), színek, tipográfia, animációk, pseudo-élések.
JavaScript (ES6+) → változók, függvények, arrow function, DOM manipuláció, eventek, async/await, Promise-k.


2. Modern frontend keretrendszerek
...
3. Stílusok, preprocesszorok

SASS / SCSS → változók, mixin-ek, nesting.
CSS modulok → lokális stíluskezelés.
Responsive design → media query-k, mobilbarát elrendezés, reszponzív UI.


4. Verziókezelés és eszközök

Git → commit, branch, merge, pull, push, rebase.
NPM/Yarn → csomagkezelés, dependency management.
Webpack / Vite / Parcel → projekt buildelés, bundling alapok.

5. API-k és kommunikáció backenddel
...
7. Egyéb fontos készségek

Cross-browser kompatibilitás → Chrome, Firefox, Edge, Safari.
Performance optimalizálás → lazy loading, code splitting, image optimization.
Soft skillek → csapatmunka, dokumentáció, problémamegoldás.
Angol nyelvtudás → dokumentáció, kommunikáció, külföldi csapatok.

8. Tapasztalat / portfólió
...
2. hét – CSS fejlettebb technikák
...
4. hét – Modern JavaScript + TypeScript
...
6. hét – API integráció és verziókezelés
...
7. hét – Tesztelés és optimalizáció
...
8. hét – Portfólió és soft-skillek
...
[ ] HTML5 szemantikus elemek (header, footer, article, section)
[ ] Linkek, képek, formok, táblázatok
[ ] CSS3 alapok: box-model, színek, fontok, display
[ ] Saját egyszerű portfólió oldal készítése

2. hét – CSS fejlettebb technikák

[ ] Flexbox alapok, igazítás, rugalmas elemek
[ ] CSS Grid alapok
[ ] Reszponzív design: media query-k, mobilbarát elrendezések
[ ] Portfólió oldal reszponzív kialakítása

3. hét – JavaScript alapok

[ ] Változók (let, const), függvények, ciklusok, feltételek
[ ] DOM manipuláció, eseménykezelés (addEventListener)
[ ] Async programozás: Promise, async/await, fetch API
[ ] Interaktív To do alkalmazás készítése

4. hét – Modern JavaScript + TypeScript

[ ] ES6+ funkciók: arrow function, destructuring, template string, spread/rest
[ ] TypeScript alapok: típusok, interface-ek, osztályok
[ ] To do alkalmazás átalakítása TypeScript-tel
